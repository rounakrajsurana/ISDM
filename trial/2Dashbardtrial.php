          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                  <a class="nav-link" href="1Home.html"><i class="fas fa-home"></i> Home <span class="sr-only">(current)</span></a>
                </li>
				<li>
...
?>
   ...
   <section class="jumbotron text-center">
     <div class="container">
       ...
       <p class="lead text-muted">You can see the course scheduled for Semester 2018 .</p>
...
<table class="table">
  ...
  <tbody>
    <tr>
      <th scope="row">1</th>
      <td><a href = "coursepage.HTML">ISDM</td></a>
      <td><ul class="nav nav-pills" id="pills-tab" role="tablist">
        <li class="nav-item">
      ...
      <td><ul class="nav nav-pills" id="pills-tab" role="tablist">
        <li class="nav-item">
          <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">EXPORT</a>
        </li>
   </ul></td>
  </tr>
    <tr>
      <th scope="row">2</th>
      <td><a href = "coursepage.HTML">DST</td></a>
      <td><ul class="nav nav-pills" id="pills-tab" role="tablist">
        <li class="nav-item">
          <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">EDIT</a>
        </li>
      ...
      <th scope="row">3</th>
      <td><a href = "coursepage.HTML">E-Business</td></a>
      <td><ul class="nav nav-pills" id="pills-tab" role="tablist">
        <li class="nav-item">
          <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">EDIT</a>
        </li>
